const QueryBar = (props) => {
    return (
        ...
        <form className="flex justify-center bg-blue-300 p-4 rounded-full shadow-lg" onSubmit={props.handleSubmit}>
            ...
            <label className="p-3">
                <div className="font-mono font-extrabold text-blue-700 text-xl text-center">Genre:</div>
            ...
            <label className="p-3">
                <div className="font-mono font-extrabold text-blue-700 text-xl text-center">Max Players:</div>
